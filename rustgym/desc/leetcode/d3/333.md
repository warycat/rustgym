<div><p>Given the root of a binary tree, find the largest subtree, which is also&nbsp;a Binary Search Tree (BST), where the largest means subtree has the largest number of nodes.</p>
